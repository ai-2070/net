...
Where v0.27.1 was pure performance and *nothing on the wire moved*, v0.27.2 leads with a four-pass security audit of the `net` crate and the fixes it surfaced — headlined by a **critical authorization-bypass** in the capability fold — then continues the hot-path work on the nRPC dispatch layer the [hot-path audit](https://github.com/ai-2070/net/blob/master/net/crates/net/docs/misc/PERF_AUDIT_2026_06_09_HOT_PATH.md) opened. The full security review is recorded in [`docs/misc/SECURITY_AUDIT_2026_06_09_NET_CRATE.md`](https://github.com/ai-2070/net/blob/master/net/crates/net/docs/misc/SECURITY_AUDIT_2026_06_09_NET_CRATE.md); this log is the operator-facing summary.
