...
- Synced the `LocalScheduler` / `ScoreHistory` / `ScoreSnapshot` sketch in [`MESH_SCHEDULER_IMPL_PLAN.md`](https://github.com/ai-2070/net/blob/master/docs/internal/plans/MESH_SCHEDULER_IMPL_PLAN.md) to the as-built types.
