...
**No wire-format change, no C-ABI change, no public API change.** Drop-in against honest v0.27.5 and earlier peers. Full audit: [`docs/misc/BUG_AUDIT_2026_06_18_BINDINGS.md`](https://github.com/ai-2070/net/blob/master/docs/internal/misc/BUG_AUDIT_2026_06_18_BINDINGS.md).
