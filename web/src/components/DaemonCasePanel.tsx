...
export function DaemonCasePanel({
  defaultCaseIndex = 0,
}: {
  defaultCaseIndex?: number;
}) {
  const caseIdxRef = useRef(defaultCaseIndex);
  ...
  return (
    <div className="border border-line bg-bg-2 overflow-hidden">
      ...
      <pre className="px-5 py-4 text-[12px] leading-[1.7] text-ink overflow-x-auto font-mono min-h-[300px]">
