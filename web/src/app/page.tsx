  ...
  return (
    <div className="mt-7 border border-line bg-bg-2">
      ...
      <div className="px-5 pt-6 pb-5">
        <svg
          className="w-full max-w-[640px] mx-auto aspect-[600/280] block"
          viewBox="0 0 600 280"
          preserveAspectRatio="xMidYMid meet"
        >
          <defs>
          ...
          <rect width="600" height="280" fill="url(#mikoshiGrid)" opacity="0.5" />
          ...
          <g>
            <rect
              ...
              rx="2"
            />
            <line x1="60" y1="62" x2="180" y2="62" stroke="#c4ff3d" strokeOpacity="0.18" />
            <line x1="60" y1="84" x2="180" y2="84" stroke="#c4ff3d" strokeOpacity="0.18" />
            <line x1="60" y1="106" x2="180" y2="106" stroke="#c4ff3d" strokeOpacity="0.18" />
            <line x1="60" y1="128" x2="180" y2="128" stroke="#c4ff3d" strokeOpacity="0.18" />
            <circle cx="70" cy="50" r="2" fill="#c4ff3d" opacity="0.75" />
            <circle cx="78" cy="50" r="2" fill="#6b8a1e" opacity="0.5" />
            <circle cx="86" cy="50" r="2" fill="#5e3535" opacity="0.5" />
            <text
              x="120"
              y="160"
              fontFamily="JetBrains Mono"
          ...
          <g>
            <rect
              ...
              rx="2"
            />
            <line x1="420" y1="62" x2="540" y2="62" stroke="#c4ff3d" strokeOpacity="0.18" />
            <line x1="420" y1="84" x2="540" y2="84" stroke="#c4ff3d" strokeOpacity="0.18" />
            <line x1="420" y1="106" x2="540" y2="106" stroke="#c4ff3d" strokeOpacity="0.18" />
            <line x1="420" y1="128" x2="540" y2="128" stroke="#c4ff3d" strokeOpacity="0.18" />
            <circle cx="430" cy="50" r="2" fill="#c4ff3d" opacity="0.75" />
            <circle cx="438" cy="50" r="2" fill="#6b8a1e" opacity="0.5" />
            <circle cx="446" cy="50" r="2" fill="#5e3535" opacity="0.5" />
            <text
              x="480"
              y="160"
              fontFamily="JetBrains Mono"
          ...
          {/* Migration arc — visible only during handoff */}
          <g>
            <animate
              attributeName="opacity"
              values="0;0;0.9;0.9;0"
              keyTimes="0;0.28;0.4;0.55;0.7"
              dur="6s"
              repeatCount="indefinite"
            />
            <path
              d="M 180 90 Q 300 30 420 90"
              fill="none"
              stroke="#c4ff3d"
              strokeWidth="1"
              strokeDasharray="4 3"
          ...
          {/* Connection: server A → subscriber */}
          <g>
            <animate
              attributeName="opacity"
              values="1;1;0.55;0.25;0.25"
              keyTimes="0;0.28;0.42;0.55;1"
              dur="6s"
              repeatCount="indefinite"
            />
            <line
          ...
          {/* Connection: server B → subscriber */}
          <g>
            <animate
              attributeName="opacity"
              values="0.25;0.25;0.55;1;1"
              keyTimes="0;0.28;0.42;0.55;1"
              dur="6s"
              repeatCount="indefinite"
            />
          ...
          <g>
            <rect
              ...
              rx="2"
            />
            <circle cx="252" cy="230" r="2" fill="#c4ff3d" opacity="0.75" />
            <text
              x="300"
              y="240"
              fontFamily="JetBrains Mono"
            ...
            <text
              ...
              textAnchor="middle"
            >
              never sees the migration
            </text>
          </g>

          {/* Daemon orb + tag — animates from inside server A to inside server B */}
          <g>
            <animateMotion
              dur="6s"
              repeatCount="indefinite"
              path="M 120 90 Q 300 30 480 90"
            ...
            <circle
              r="8"
              fill="#c4ff3d"
              style={{ filter: "drop-shadow(0 0 8px #c4ff3d)" }}
            />
            <text
              y="-20"
              fontFamily="JetBrains Mono"
          ...
          {/* Caption: "daemon" floating with the orb (subtle) */}
          <text
            x="300"
            y="200"
            fontFamily="JetBrains Mono"
            ...
            opacity="0.7"
          >
            origin_hash unchanged · subscribers keep receiving
          </text>
        </svg>
