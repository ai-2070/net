...
//!
//! Kyra's `parent-round4-final.rs` (fourth Stage 5 review, HOLD at
//! `516a45c33`; rerun unchanged in her fifth, HOLD at `60e120609`),
//! landed verbatim as a pinned test. The only change is the S6-01
