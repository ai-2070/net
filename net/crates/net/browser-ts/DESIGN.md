# `@net-mesh/browser` — design notes

> For people working **on** this package. If you are building a game or a page
> **with** it, start with [README.md](README.md) instead.
>
> These notes record how the package is built and why: the wasm boundary, the
> typed-error taxonomy and the reasoning behind each error kind, the ICE/UDP
> classification and what was measured, the stream contract and how it is tested
> against the built artifacts, teardown order, identity, and bundle sizes.
