...
use net_sdk::enrollment::invite::{
    EnrollmentEndpoint, InviteSpec, MembershipInvite, RedemptionIntent, Relation,
};
use net_sdk::enrollment::policy::{ApprovalMode, InvitationPolicy};
use net_sdk::enrollment::redeem::{redeem_over, RedeemError, RedeemOutcome, Refusal};
    ...
    fn invite(&self) -> MembershipInvite {
        let invite = MembershipInvite::sign(
            ...
            InviteSpec {
                ...
                endpoint: EnrollmentEndpoint::parse("192.0.2.1:9").unwrap(),
