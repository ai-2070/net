...
**Why keep going past this:** tier-1 tourist path. Everything below is what makes native worth it.
...
- [ ] **Prerequisite:** memo §8 succession rule specified (two-nodes-one-identity edge case will show up here)
