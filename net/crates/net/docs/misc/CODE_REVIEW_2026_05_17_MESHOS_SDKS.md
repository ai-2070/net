...
| Polish (remaining) | Document or align option drift (item 18); fix Go stream Close/Next race (item 19); document or align audit-stream timeout semantics (item 20); improve Go cgo idioms (item 22). |
