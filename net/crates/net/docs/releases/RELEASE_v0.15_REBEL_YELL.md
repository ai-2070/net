...
The full plan + design rationale lives in [`DATAFORTS_BLOB_STORAGE_PLAN.md`](../../../../../docs/internal/plans/DATAFORTS_BLOB_STORAGE_PLAN.md). Shipped as PR-5a through PR-5r + a post-feature hardening bundle.
...
The full per-commit log lives in the plan doc's [Shipping status](../../../../../docs/internal/plans/DATAFORTS_BLOB_STORAGE_PLAN.md#shipping-status) table under "Hardening — post-PR-5j hardening pass."
...
The plan + design rationale lives in [`DATAFORTS_BLOB_OVERFLOW_PLAN.md`](../../../../../docs/internal/plans/DATAFORTS_BLOB_OVERFLOW_PLAN.md). Shipped as P1..P5 across five commits on the `dataforts-overflow` branch.
