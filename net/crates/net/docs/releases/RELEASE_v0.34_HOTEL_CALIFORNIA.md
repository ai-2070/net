...
- **New pages for the new planes.** [Organizations](https://ai2070.net/docs/concepts/organizations), [Security model](https://ai2070.net/docs/concepts/security-model), [Agent identity](https://ai2070.net/docs/concepts/agent-identity), [Tool federation](https://ai2070.net/docs/concepts/tool-federation), a rewritten [Subnets](https://ai2070.net/docs/concepts/subnets), and the end-to-end [Private capabilities](https://ai2070.net/docs/guides/private-capabilities) walkthrough — which opens by telling you when *not* to reach for org auth, and says plainly that capability `scope:*` tags filter your own query and stop nobody. Plus [Production deployment](https://ai2070.net/docs/guides/production-deployment), [Troubleshooting](https://ai2070.net/docs/guides/troubleshooting), [Gang scheduler](https://ai2070.net/docs/guides/gang-scheduler), [Mesh streams](https://ai2070.net/docs/guides/mesh-streams), [Task lifecycle](https://ai2070.net/docs/guides/task-lifecycle), [Agent-to-agent](https://ai2070.net/docs/guides/agent-to-agent), a [Glossary](https://ai2070.net/docs/reference/glossary), and a [Versioning](https://ai2070.net/docs/reference/versioning) page.
