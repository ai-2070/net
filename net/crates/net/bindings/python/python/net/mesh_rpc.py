...
try:
    ...
    _RawMeshRpc = None  # type: ignore[misc,assignment]
    _RawAsyncMeshRpc = None  # type: ignore[misc,assignment]
    _RawAsyncRpcStream = None  # type: ignore[misc,assignment]
    _RawAsyncClientStreamCall = None  # type: ignore[misc,assignment]
    _RawAsyncDuplexCall = None  # type: ignore[misc,assignment]
    _RawAsyncDuplexSink = None  # type: ignore[misc,assignment]
    _RawAsyncDuplexStream = None  # type: ignore[misc,assignment]
    _RawRpcStream = None  # type: ignore[misc,assignment]
    _RawClientStreamCall = None  # type: ignore[misc,assignment]
    _RawDuplexCall = None  # type: ignore[misc,assignment]
    _RawDuplexSink = None  # type: ignore[misc,assignment]
    _RawDuplexStream = None  # type: ignore[misc,assignment]
    _RawRequestStreamRecv = None  # type: ignore[misc,assignment]
    _RawResponseSinkSend = None  # type: ignore[misc,assignment]
    _RawRpcCallEvent = None  # type: ignore[misc,assignment]
    _RawRpcMetricsSnapshot = None  # type: ignore[misc,assignment]
    _RawServiceMetrics = None  # type: ignore[misc,assignment]
