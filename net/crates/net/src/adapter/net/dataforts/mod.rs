...
pub use blob::{
    ...
    drive_blob_migration_tick, drive_blob_migration_tick_arc, evaluate_health_gate,
    ...
    BlobDurability, BlobError, BlobMetrics, BlobMetricsSnapshot, BlobMigrationCandidate,
    BlobMigrationController, BlobMigrationTickReport, BlobRef, BlobRefcountTable, BlobStat,
    ChunkRangeRequest, ChunkRef, ChunkedPayload, Encoding, EventPayload, FileSystemAdapter,
    HealthGateAction, MeshBlobAdapter, MigrateBlobReject, MigrateBlobVerdict, NoopAdapter,
    ...
    BLOB_REF_VERSION_V2_MANIFEST, DEFAULT_BLOB_HEAT_HALF_LIFE, DEFAULT_RETENTION_FLOOR,
