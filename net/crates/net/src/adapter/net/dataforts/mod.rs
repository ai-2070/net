...
#[cfg(feature = "dataforts")]
pub use gravity::{
    should_emit_heat, BlobHeatRegistry, BlobHeatSink, DataGravityPolicy, DataGravityPolicyError,
...
pub use blob::{
    ...
    drive_blob_migration_tick_with_manifest_resolver, evaluate_health_gate,
    global_blob_adapter_registry, parse_blob_heat_tag, publish_blob, publish_blob_ref,
    ...
    BlobDurability, BlobError, BlobInventoryEntry, BlobListOptions, BlobMetrics,
    BlobMetricsSnapshot, BlobMigrationCandidate, BlobMigrationController, BlobMigrationTickReport,
    BlobRef, BlobRefcountTable, BlobStat, ChunkRangeRequest, ChunkRef, ChunkedPayload, Encoding,
    EventPayload, FileSystemAdapter, HealthGateAction, ManifestSiblings, MeshBlobAdapter,
    MigrateBlobReject, MigrateBlobVerdict, NoopAdapter, OverflowConfig, OverflowMetricsSnapshot,
    PublishWithBlobReceipt, PullBlobReject, PullBlobVerdict, RefcountEntry, BLOB_CHUNK_SIZE_BYTES,
    BLOB_MANIFEST_BODY_VERSION, BLOB_MANIFEST_MAX_CHUNKS, BLOB_REF_DISCRIMINATOR, BLOB_REF_MAGIC,
    BLOB_REF_MAX_SIZE, BLOB_REF_SMALL_HEADER_LEN, BLOB_REF_VERSION_V1,
    BLOB_REF_VERSION_V2_MANIFEST, DEFAULT_BLOB_HEAT_HALF_LIFE, DEFAULT_OVERFLOW_HIGH_WATER_RATIO,
