...
pub(crate) use org_gate::{
    ...
    capture_live_org_relay_membership_seamed, capture_sensing_authority_snapshot,
    count_org_rejection, plan_local_org_provider_registration, plan_provider_continuation,
    selector_names_target, validate_org_frame_shape, verify_org_admission,
    with_fenced_current_authority, AdmittedSensingRegistration, LiveOrgRelayMembership,
    LocalOrgEgress, RegistrationAuthority, RegistrationLeg, RelayMembershipUnavailable,
    SensingAuthoritySnapshot, SensingAuthorityStamp, SensingAuthorityUnavailable,
};
#[cfg(feature = "redex")]
pub use rendezvous::{
