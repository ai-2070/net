...
impl PacketBuilder {
    ...
    pub fn build(
        ...
        // Patch payload_len to exclude the 16-byte auth tag (bytes 64..66
        // post-`WIRE_ORIGIN_HASH_64BIT`; was 60..62 when the header was
        // 64 bytes and origin_hash was u32).
        ...
        header_bytes[64..66].copy_from_slice(&payload_len.to_le_bytes());
