...
- `docs/internal/plans/MCP_BRIDGE_PLAN.md` — the design of record (phases, doctrine, open risks).
- `docs/internal/plans/MCP_CREDENTIAL_FORWARDING_PLAN.md` — the forwarding design of record (deny-by-default posture, phases, threat model).
