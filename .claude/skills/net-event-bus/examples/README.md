...
| TypeScript, Go, C | no paid A2A surface exists to exercise — Go and C have no A2A at all, and Node's paid serving is an explicit non-goal. `docs/data/examples.yaml` records the reason per binding. |
